package com.reader.widget.selectable;
...
/**
 * Created by DongZ on 2015/9/22 0022.
 */
public class SelectableTextView extends TextView {
    ...
    private mCursonSelectionTextListener mCursonSelectionTextListener;
    /**
    ...
    private void init() {
        ...
        mDefaultSelectionColor = Color.parseColor("#FF84CC17");
    ...
    private class SelectionCursorController implements ViewTreeObserver.OnTouchModeChangeListener {
        ...
        public SelectionCursorController() {
            ...
            mStartHandle.setmDrawable(true);
            mEndHandle = new CursorHandle(this);
            mEndHandle.setmDrawable(false);
        }
...
//            cursorHandle.pointTo(x, y);
    ...
    private class CursorHandle extends View {
        ...
        public CursorHandle(SelectionCursorController controller) {
            ...
            mDrawable = getResources().getDrawable(R.mipmap.text_select_handle_left_mtrl_alpha);
        ...
        public void setmDrawable(boolean isLeft){
            if(isLeft){
                mDrawable = getResources().getDrawable(R.mipmap.text_select_handle_left_mtrl_alpha);
                ...
                mDrawable = getResources().getDrawable(R.mipmap.text_select_handle_right_mtrl_alpha);
                mHeight = mDrawable.getIntrinsicHeight();
                mWidth = mDrawable.getIntrinsicWidth();
                mHotspotX = 0;
                invalidate();
        ...
        public boolean /*CursorHandle::*/onTouchEvent(MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_CANCEL: {
                    ...
                    if(mCursonSelectionTextListener != null){
                        mCursonSelectionTextListener.selectText(SelectableTextView.this.getCursorSelection().getSelectedText().toString());
                    }
...
//                    int curOff = layout.getOffsetForHorizontal(line, (int)event.getX());
    ...
    public void setmCursorSelection(mCursonSelectionTextListener listener){
        mCursonSelectionTextListener = listener;
    }

    public interface mCursonSelectionTextListener{
    ...
    //��ȡ����
    public int extractWordCurOff(int x, int y) {
        int line;
        Layout layout = getLayout();
    ...
    public String getSelectWord(String content, int curOff) {
        String word = "";
    ...
    public int getWordLeftIndex(String content, int cur) {
        // --left
    ...
    public int getWordRightIndex(String content, int cur) {
        // --right
